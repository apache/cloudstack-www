...
Apache CloudStack™  is an open-source software system designed to deploy and manage large networks of virtual machines, as a highly available, highly scalable Infrastructure as a Service (IaaS) cloud computing platform.
	      ...
	      &nbsp;
              <a href="https://docs.cloudstack.apache.org/en/4.23.0.0/" target="_blank" className="btn btn-outline-light btn-size">Documentation</a>
              <p className="small mt-3">Apache CloudStack 4.23.0.0 is out!</p>
            </div>
          </div>
      ...
      <div className="partners-holder">
        <div className="partners">
          ...
          <img src="/img/Yotta_Data_Services_Logo.jpg" height="35" alt=""/>
...
specific infrastructure.
            ...
            <div className="row">
              <div className="col col-lg-5">
                ...
                <div className="center-buttons">
                  <p className="px18">Apache CloudStack 4.23.0.0 is out!<br/>This is the latest Regular release.</p>
                  <a href="downloads" className="btn btn-primary btn-size">Download</a>
                  &nbsp;
                  <a href="https://docs.cloudstack.apache.org/en/4.23.0.0/" target="_blank" className="btn btn-outline-secondary btn-size">Documentation</a>
                </div>
              </div>
