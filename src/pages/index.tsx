...
Apache CloudStack™  is an open-source software system designed to deploy and manage large networks of virtual machines, as a highly available, highly scalable Infrastructure as a Service (IaaS) cloud computing platform.
	      ...
	      &nbsp;
              <a href="https://docs.cloudstack.apache.org/en/4.19.1.1/" target="_blank" className="btn btn-outline-light btn-size">Documentation</a>
...
specific infrastructure.
            ...
            <div className="row">
              <div className="col col-lg-5">
                ...
                <div className="center-buttons">
                  <p className="px18">Apache CloudStack 4.19.1.1 is out!<br/>This is the latest LTS release.</p>
                  <a href="downloads" className="btn btn-primary btn-size">Download</a>
                  &nbsp;
                  <a href="https://docs.cloudstack.apache.org/en/4.19.1.1/" target="_blank" className="btn btn-outline-secondary btn-size">Documentation</a>
                </div>
              </div>
